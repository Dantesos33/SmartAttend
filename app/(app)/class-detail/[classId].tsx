...
export default function ClassDetailScreen() {
  ...
  const classNames: Record<string, string> = {
    ...
    '2': 'MATH202 - Mathematics',
    '3': 'PHY301 - Physics',
    '4': 'ENG101 - English',
  };

  const className = classNames[classId || '1'] || 'Class Detail';
  ...
  const options = [
    {
      ...
      icon: 'person-add',
      color: '#2563EB',
      onPress: () => router.push({ pathname: '/(app)/add-student/[classId]', params: { classId } })
    },
    {
      title: 'View Students',
      ...
      icon: 'people',
      color: '#8B5CF6',
      onPress: () => router.push({ pathname: '/(app)/students/[classId]', params: { classId } })
    },
    {
      ...
      onPress: () => {
        ...
        router.push({ pathname: '/(app)/camera/[classId]', params: { classId } });
      }
    }
  ];
...
const styles = StyleSheet.create({
  ...
  content: { padding: 24 },
  sectionTitle: { fontSize: 16, fontWeight: '600', color: '#64748B', marginBottom: 24 },
  ...
  optionTitle: { fontSize: 18, fontWeight: 'bold', color: '#0F172A', marginBottom: 4 },
